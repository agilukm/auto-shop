                        ...
                        <div class="testimonial-widget-one owl-carousel owl-theme">
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/2.jpg" alt="" />
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/3.jpg" alt="" />
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/1.jpg" alt="" />
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/4.jpg" alt="" />
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/5.jpg" alt="" />
                                    <div class="testimonial-author">TYRION LANNISTER</div>
                                    <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{ url('/')}}admin/images/avatar/6.jpg" alt="" />
                                    <div class="testimonial-author">TYRION LANNISTER</div>
                                    <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img src="{{ url('/')}}admin/images/avatar/4.jpg" alt=""></a>
                                            </div>
                                        </td>
                                        <td>John Abraham</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img src="{{ url('/')}}admin/images/avatar/2.jpg" alt=""></a>
                                            </div>
                                        </td>
                                        <td>John Abraham</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img src="{{ url('/')}}admin/images/avatar/3.jpg" alt=""></a>
                                            </div>
                                        </td>
                                        <td>John Abraham</td>
                        ...
                        <div class="recent-comment">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img alt="..." src="{{ url('/')}}admin/images/avatar/1.jpg" class="media-object"></a>
                                </div>
