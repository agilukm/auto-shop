...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="{{ url('/')}}/admin/images/logo.png" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="{{ url('/')}}/admin/images/logo-text.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{ url('/')}}/admin/images/users/5.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{ url('/')}}/admin/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{ url('/')}}/admin/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{ url('/')}}/admin/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
    ...
    <!-- Amchart -->
     <script src="{{ url('/')}}/admin/js/lib/morris-chart/raphael-min.js"></script>
    <script src="{{ url('/')}}/admin/js/lib/morris-chart/morris.js"></script>
    <script src="{{ url('/')}}/admin/js/lib/morris-chart/dashboard1-init.js"></script>


	<script src="{{ url('/')}}/admin/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="{{ url('/')}}/admin/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="{{ url('/')}}/admin/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
    <script src="{{ url('/')}}/admin/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <!-- scripit init-->
    <script src="{{ url('/')}}/admin/js/lib/calendar-2/pignose.init.js"></script>

    <script src="{{ url('/')}}/admin/js/lib/owl-carousel/owl.carousel.min.js"></script>
    <script src="{{ url('/')}}/admin/js/lib/owl-carousel/owl.carousel-init.js"></script>
