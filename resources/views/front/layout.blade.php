...
<html>
   ...
   <body>
                              ...
                              <ul class="dropdown-menu multi-column columns-3">
                                 <div class="agile_inner_drop_nav_info">
                                    <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
                                       <a href="mens.html"><img src="{{ URL('/') }}/front/images/top2.jpg" alt=" "/></a>
                                    </div>
                              ...
                              <ul class="dropdown-menu multi-column columns-3">
                                 <div class="agile_inner_drop_nav_info">
                                    ...
                                    <div class="col-sm-6 multi-gd-img multi-gd-text ">
                                       <a href="womens.html"><img src="{{ URL('/') }}/front/images/top1.jpg" alt=" "/></a>
                                    </div>
                                    <div class="clearfix"></div>
                                 </div>
                              </ul>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body modal-body-sub_agile">
                  ...
                  <div class="col-md-4 modal_body_right modal_body_right1">
                     <img src="{{ URL('/') }}/front/images/log_pic.jpg" alt=" "/>
                  </div>
                  <div class="clearfix"></div>
               </div>
            </div>
            ...
            <div class="col-md-9 footer-right">
               <div class="sign-grds">
                  ...
                  <div class="col-md-3 sign-gd flickr-post">
                     ...
                     <ul>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                        <li><a href="single.html"><img src="{{ URL('/') }}/front/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
      ...
      <!-- //js -->
      <script src="{{ URL('/') }}/front/js/modernizr.custom.js"></script>
      <!-- Custom-JavaScript-File-Links -->
      <!-- cart-js -->
      <script src="{{ URL('/') }}/front/js/minicart.min.js"></script>
      <script>
         // Mini Cart
      ...
      <script src="{{ URL('/') }}/front/js/easy-responsive-tabs.js"></script>
      <script>
      ...
      <script src="{{ URL('/') }}/front/js/jquery.countup.js"></script>
      <script>
         $('.counter').countUp();
      </script>
      <!-- //stats -->
      ...
      <script type="text/javascript" src="{{ URL('/') }}/front/js/jquery.easing.min.js"></script>
